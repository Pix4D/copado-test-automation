...
2CO Purchase Flow
    ...
    # check invoive
    # then go org page XXX you need org UUID
    # becasue admin => https://dev.account.pix4d.com/organization/440698cb-fe9f-4bf6-b3c0-cb74b9e72361/credits
    # https://dev.account.pix4d.com/organization/{org_uuid}/credits
    # check credits
    # LoginAppStagingAP
    GoTo                        ${url_dev}/organization/${org_uuid}/credits     timeout=5
