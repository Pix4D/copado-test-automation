...
${locator_agree_table}    xpath\=//*[@id\='order__checkout__payoptions__data']/div[1]/div[1]/div[1]/div[3]/div[2]/div[2]/table[1]
${locator_agree_checkbox}    r?\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tYes, I agree to the Pix4D General Terms and Conditions*\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t/c1
...
2CO Purchase Flow
    ...
    ClickText              order__checkout__form__mandatory
